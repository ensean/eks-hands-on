...
为限制eksctl、awscli用户的权限，可以考虑参考[这里](https://eksctl.io/usage/minimum-iam-policies/)为用户配置最小权限

## 配置方式

为新建用户赋予如下四个策略

* AmazonEC2FullAccess（托管策略）
* AWSCloudFormationFullAccess（托管策略）
